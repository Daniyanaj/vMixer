...
from vmixer.training.data_augmentation.data_augmentation_moreDA import get_moreDA_augmentation
...
import numpy as np
from vmixer.training.loss_functions.deep_supervision import MultipleOutputLoss2
from vmixer.training.network_training.vmixerTrainerV2 import vmixerTrainerV2
...
class vmixerTrainerV2CascadeFullRes(vmixerTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="vmixerTrainerV2", fp16=False):
