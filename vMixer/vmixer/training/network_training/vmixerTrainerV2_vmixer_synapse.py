...
from vmixer.network_architecture.vmixer_synapse import vmixer
...
class vmixerTrainerV2_vmixer_synapse(vmixerTrainer_synapse):
    """
    ...
    def initialize_network(self):
        ...
        self.network=vmixer(crop_size=self.crop_size,
