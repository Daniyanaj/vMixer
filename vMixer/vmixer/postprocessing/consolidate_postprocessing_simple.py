...
import argparse
from vmixer.postprocessing.consolidate_postprocessing import consolidate_folds
from vmixer.utilities.folder_names import get_output_folder_name
from vmixer.utilities.task_name_id_conversion import convert_id_to_task_name
from vmixer.paths import default_cascade_trainer, default_trainer, default_plans_identifier
...
def main():
    ...
    argparser.add_argument("-tr", type=str, required=False, default=None,
                           help="vmixerTrainer class. Default: %s, unless 3d_cascade_fullres "
    ...
    if trainer is None:
        if model == "3d_cascade_fullres":
            trainer = "vmixerTrainerV2CascadeFullRes"
        else:
            trainer = "vmixerTrainerV2"
