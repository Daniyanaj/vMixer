...
import numpy as np
from vmixer.experiment_planning.experiment_planner_baseline_3DUNet_v21 import \
...
class ExperimentPlanner3D_v21_32GB(ExperimentPlanner3D_v21):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "vmixerData_plans_v2.1_verybig"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "vmixerPlansv2.1_verybig_plans_3D.pkl")
