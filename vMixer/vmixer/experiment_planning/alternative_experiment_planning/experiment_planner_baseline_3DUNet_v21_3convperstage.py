...
import numpy as np
from vmixer.experiment_planning.common_utils import get_pool_and_conv_props
from vmixer.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner
from vmixer.experiment_planning.experiment_planner_baseline_3DUNet_v21 import ExperimentPlanner3D_v21
...
class ExperimentPlanner3D_v21_3cps(ExperimentPlanner3D_v21):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder,
                                "vmixerPlansv2.1_3cps_plans_3D.pkl")
