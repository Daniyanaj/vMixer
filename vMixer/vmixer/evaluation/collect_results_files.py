...
def crawl_and_copy(current_folder, out_folder, prefix="fabian_", suffix="summary.json"):
    """
...
if __name__ == "__main__":
    ...
    output_folder = "/home/fabian/PhD/results/vmixerV2/leaderboard"
    crawl_and_copy(network_training_output_dir, output_folder)
    from vmixer.evaluation.add_mean_dice_to_json import run_in_folder
